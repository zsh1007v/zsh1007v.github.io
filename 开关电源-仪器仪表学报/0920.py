...
if __name__ == '__main__':
    ...
    print('Accuracy on test set:{}'.format(model_23.evaluate([X_test_2d, X_test_2d_T], y_test_hot, verbose=0)))
    # predict
    ...
    print(FC_train_feature23_CNN.shape)
    ...
    print(FC_train_feature23_L.shape)
    ...
    plt.show()
    # # loss
    # plt.plot(iters, lh_3.losses['batch'], 'g', label='train loss')
    # if loss_type == 'batch':
    #     # val_acc
